...
#' @param time.format Can be either \code{date}, or \code{raw}.
...
#'
#' The original data was downloaded from: \link{http://ec.europa.eu/eurostat/ramon/nomenclatures/index.cfm?TargetUrl=LST_CLS_DLD&StrNom=NUTS_2013L&StrLanguageCode=EN&StrLayoutCode=HIERARCHIC}
#'
